                ...
                <div className='flex flex-row items-center justify-between w-[90%]'>
                  <div className="mb-5">
                    <label for="visa" className="flex items-center cursor-pointer md:flex-col md:flex-col-reverse">
                      ...
                      <img src="/assets/logos/visa.png" className="h-8 w-10 ml-3" />
                    </label>
                  </div>
                  <div className="mb-3">
                    <label for="airtel" className="flex items-center cursor-pointer md:flex-col md:flex-col-reverse">
                      ...
                      <img src="/assets/logos/airtel.png" className="h-8 w-10 object-contain ml-3" />
                    </label>
                  </div>
                  <div className="mb-3">
                    <label for="mtn" className="flex items-center cursor-pointer md:flex-col md:flex-col-reverse">
                      ...
                      <img src="/assets/logos/mtn.png" className="h-8 w-10 object-contain ml-3" />
                    </label>
                  </div>
                </div>
